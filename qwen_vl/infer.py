...
def evaluate_and_save(eval_dataset, model, processor):
    ...
    output_path = os.path.join(generations_dir, f"{args.output_prefix}_generated.jsonl")
    with open(output_path, "a", encoding="utf-8") as f_out:
        ...
        write_json(os.path.join(results_dir, f"{args.output_prefix}_full_results.json"), {"results": full_results})
